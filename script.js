...
const products4 = [
  { id: 15, name: "Sofa set", price: 700000, img: "./Images/Sofa set.jpeg" },
  {
    ...
    name: "Single seater",
    price: 300000,
    img: "./Images/Chair design.jpeg",
  },
  {
    id: 17,
    name: "Luxury Sofa",
    price: 800000,
    img: "./Images/Blue sofa.jpeg",
  },
...
const products5 = [
  {
    ...
    name: "Blue Table",
    price: 800000,
    img: "./Images/Blue table.jpeg",
  },
  {
    id: 20,
    name: "Center Table",
    price: 700000,
    img: "./Images/Center table 3.jpeg",
  },
  {
    id: 21,
    name: "Center Table",
    price: 900000,
    img: "./Images/Center Table1.jpeg",
  },
  {
    id: 22,
    name: "Table Design",
    price: 450000,
    img: "./Images/Table design.jpeg",
  },
  {
    id: 23,
    name: "Mirror table",
    price: 500000,
    img: "./Images/Mirror table.jpeg",
  },
];
    ...
    .map(
      (p) => `
        ...
        p.name
            ...
            <button onclick="addToCart(${p.id}, '${p.name.replace(
        /'/g,
        "\\'"
      )}', ${p.price})">Add to Cart</button>
        </div>
    `
    )
    .join("");
